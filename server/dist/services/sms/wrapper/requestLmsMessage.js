    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let sendInfo = yield dbTran(storeId, function (conn) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (purpose !== 'auth') {
                    yield smsCreditService.useLmsCredit(conn, useStoreId, 1);
                }
                let send = yield sendService.registerSend(conn, { storeId, fromPhoneNumber, purpose, smsType: 'lms', subject, message }, { phoneNumber: toPhoneNumber });
                if (sendNow) {
