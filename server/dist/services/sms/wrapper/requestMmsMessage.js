...
module.exports = function (params, context) {
    return __awaiter(this, void 0, void 0, function* () {
        const { storeId, reservedSendDate, purpose, toPhoneNumber, fromPhoneNumber, message, subject, contents, smsCreditUseStoreId } = params || {};
        ...
        let sendInfo = yield dbTran(storeId, function (conn) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (purpose !== 'auth') {
                    yield smsCreditService.useMmsCredit(conn, useStoreId, 1);
                }
                let send = yield sendService.registerSend(conn, { storeId, fromPhoneNumber, purpose, smsType: 'mms', subject, message }, { phoneNumber: toPhoneNumber });
                if (sendNow) {
                    yield smsSendByDbService.requestMmsMessageByDb(conn, {
