...
module.exports = {
    sendSms: function (msg_1) {
        return __awaiter(this, arguments, void 0, function* (msg, useAlimtalk = false) {
            ...
            if (kakaoAlimtalkSenderkey && templateCode) {
                return requestAlimtalkMessage(Object.assign(Object.assign({}, params), { subject,
                    messageType,
                    pageUrl, param: msg.param, senderKey: kakaoAlimtalkSenderkey, templateCode }));
            }
            else if (_.get(msg, 'contents.length') > 0) {
                return requestMmsMessage(Object.assign(Object.assign({}, params), { message,
                    subject, contents: msg.contents }));
            }
            else if (_.get(message, 'length') > 45) {
                return requestLmsMessage(Object.assign(Object.assign({}, params), { message,
                    subject }));
            }
            else if (_.get(message, 'length') > 0) {
                return requestSmsMessage(Object.assign(Object.assign({}, params), { message,
                    subject }));
            }
        });
    },
